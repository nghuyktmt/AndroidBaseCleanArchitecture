...
import com.huyn.cleanarchitecture.databinding.FragmentTopicDetailBinding
...
class TopicDetailFragment :
    BaseViewBindingFragment<FragmentTopicDetailBinding, TopicDetailViewModel>(
        FragmentTopicDetailBinding::inflate
    ) {
